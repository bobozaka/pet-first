...
const Hero = () => {
  return (
    <section className="bg-cream lg:bg-hero lg:bg-cover lg:bg-no-repeat min-h-[400px] lg:min-h-[805px]">
      <Header />
      <div className="container mx-auto flex justify-start item-centr min-h-[400px] lg:h-[805px]">
        <div className="lg:max-w-[650px] text-center mx-auto lg:text-left lg:mx-0">
          ...
          <h1 className="text-5xl lg:text-8xl uppercase font-bold -tracking-[0.05em] mb-10">
            Самый лучший
            <br /> <span className="text-orange font-normal">подход к</span>
            <br /> лечению
            <br /> домашних животных
          </h1>
          <button className="btn btn-orange mx-auto lg:mx-0">Подробнее</button>
        </div>
      </div>
    </section>
  );
